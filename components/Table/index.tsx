...
export function OptionTable({ headings, options }: { headings: [string, string, string], options: [string, string, any][] }) {
  return (
    <div
      className={
      ...
      <table className="w-full border-collapse text-sm">
        <thead>
          <tr className="border-b py-4 text-left dark:border-neutral-700">
            <th className="py-2 font-semibold ">{headings[0]}</th>
            <th className="py-2 pl-6 font-semibold">{headings[1]}</th>
            <th className="px-6 py-2 font-semibold">{headings[2]}</th>
          </tr>
        </thead>
